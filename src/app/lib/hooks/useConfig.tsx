...
export const useConfig = () => {
  ...
  if (context === undefined) {
    console.warn("useConfig called outside of ConfigProvider");
    return { 
      config: { ...defaultConfig, settings: { ...defaultConfig.settings, theme_color: 'cyan' } },
      setUserSettings: () => {}
    };
  }
  return {
    ...
    config: {
      ...
      settings: {
        ...
        theme_color: context.config.settings.theme_color || 'cyan'
      }
    }
  };
};
